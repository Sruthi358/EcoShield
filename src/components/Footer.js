    ...
    <footer className="bg-[#131921] text-gray-300">
      ...
      <div className="max-w-7xl mx-auto px-6 py-14 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        ...
        <div>
          <h2 className="text-xl font-bold text-white mb-3">
            Eco<span className="text-green-400">Shield</span>
          </h2>
          <p className="text-sm leading-relaxed">
          EcoShield is an AI-powered sustainable shopping platform that
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>Email: ecoshield@gmail.com</li>
      ...
      <div className="border-t border-gray-700">
        <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col sm:flex-row justify-between items-center text-sm text-gray-400">
          <p>© {new Date().getFullYear()} EcoShield. All rights reserved.</p>
